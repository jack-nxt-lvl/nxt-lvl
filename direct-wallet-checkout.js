(() => {
  ...
  style.textContent = `
    ...
    .nxt-wallet-usdt-buy-copy span{font-size:9.25px;line-height:1.5}.nxt-wallet-usdt-methods{display:flex;flex-wrap:wrap;gap:6px;margin:-1px 0 10px}.nxt-wallet-usdt-methods span{padding:5px 8px;border:1px solid rgba(125,211,252,.20);border-radius:999px;background:rgba(14,165,233,.09);color:#d9f4ff;font-size:7.5px;font-weight:850;letter-spacing:.1px}.nxt-wallet-usdt-tip{display:grid;grid-template-columns:auto 1fr;align-items:center;gap:8px;margin:0 0 10px;padding:9px 10px;border:1px solid rgba(250,204,21,.22);border-radius:9px;background:rgba(161,98,7,.10);color:#fef3c7;font-size:8.5px;line-height:1.45}.nxt-wallet-usdt-tip b{padding:4px 7px;border-radius:999px;background:rgba(250,204,21,.14);color:#fde68a;font-size:7px;letter-spacing:.35px;text-transform:uppercase}.nxt-wallet-usdt-match{margin-top:9px;padding:10px 11px;border:1px solid rgba(167,139,250,.26);border-radius:10px;background:linear-gradient(135deg,rgba(124,58,237,.13),rgba(37,99,235,.09))}.nxt-wallet-usdt-match b{display:block;margin-bottom:4px;color:#eee8ff;font-size:9px}.nxt-wallet-usdt-match span{display:block;color:#c4bfd7;font-size:8.25px;line-height:1.5}.nxt-wallet-usdt-privacy{margin-top:9px;padding:10px 11px;border:1px solid rgba(52,211,153,.22);border-radius:10px;background:linear-gradient(135deg,rgba(16,185,129,.10),rgba(6,78,59,.08));color:#c7f9e4}.nxt-wallet-usdt-privacy b{display:block;margin-bottom:4px;color:#d9fff0;font-size:9px}.nxt-wallet-usdt-privacy span{display:block;color:#b5d8ca;font-size:8.25px;line-height:1.5}.nxt-wallet-usdt-buy-main:focus-visible{outline:3px solid rgba(125,211,252,.75);outline-offset:3px}
