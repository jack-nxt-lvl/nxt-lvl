...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    if(!r.ok||!widgetUrl)return json(res,r.status||502,{error:d?.message||d?.error||'Unable to start Transak checkout.'});
