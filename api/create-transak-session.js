...
function allowedOrigin(req){const origin=String(req.headers.origin||'').replace(/\/$/,'');return origin==='https://www.nxtlvl-research.com'||origin==='https://nxtlvl-research.com'}
