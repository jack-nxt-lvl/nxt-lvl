...
const compounds = [
  ...
  },
  {
    ...
    category: 'freeze-dried',
    protocols: ['energy-vitality', 'fat-loss'],
    badge: '',
    tags: ['Growth Hormone', 'Anti-Aging', 'Muscle', 'Fat Loss', 'Recovery'],
    shortDesc: 'Recombinant human growth hormone for body composition and anti-aging research.',
    description: 'Recombinant HGH (somatropin) is the gold standard for growth hormone research. Studied for effects on body composition, recovery, sleep quality, skin elasticity, and anti-aging.',
    benefits: ['Direct GH supplementation', 'Studied for fat loss and lean mass', 'Improves sleep and recovery', 'Skin elasticity and anti-aging', 'Well-characterized effects'],
    sideEffects: ['Joint pain', 'Water retention', 'Carpal tunnel syndrome', 'Elevated blood glucose', 'Numbness/tingling'],
    dosing: {
      beginner: { dose: '2 IU', frequency: '1x daily', duration: '8-12 weeks', notes: 'AM fasted injection' },
      intermediate: { dose: '3-4 IU', frequency: '1x daily', duration: '12-16 weeks', notes: 'Split AM/PM or full AM dose' },
      advanced: { dose: '4-6 IU', frequency: '1x daily', duration: '16+ weeks', notes: 'Monitor IGF-1 and blood glucose' }
    },
    amount: '10 IU per vial', form: 'Lyophilized Powder', appearance: 'White Powder',
    purity: '>99%', molecularFormula: 'C₉₉₀H₁₅₂₈N₂₆₂O₃₀₀S₇', halfLife: '~2-3 hours',
    reconstitution: 'Add 1 mL BAC water for 10 IU/mL.',
    syringe: 'Insulin syringe, 29-31 gauge', injectionSite: 'SubQ in abdominal fat.',
    storage: 'Store at -4°F. Reconstituted: 36-46°F, use within 14 days.', administration: 'SubQ',
  ...
  },
  {
    ...
    protocols: ['energy-vitality'],
    badge: '',
    tags: ['Hormonal', 'Testosterone', 'Fertility', 'LH', 'PCT'],
    shortDesc: 'Peptide hormone for testosterone production and fertility research.',
    description: 'HCG mimics luteinizing hormone to stimulate testosterone production and support fertility. Commonly used in hormonal research and PCT protocols.',
    benefits: ['Stimulates testosterone production', 'Supports LH activity', 'Fertility and reproductive health', 'Prevents testicular atrophy', 'Well-established research tool'],
    sideEffects: ['Water retention', 'Mood changes', 'Injection site pain', 'Headache', 'Gynecomastia risk'],
    dosing: {
      beginner: { dose: '250-500 IU', frequency: '2-3x per week', duration: '4-8 weeks', notes: 'Low dose maintenance' },
      intermediate: { dose: '500-1000 IU', frequency: '2-3x per week', duration: '8-12 weeks', notes: 'Standard protocol' },
      advanced: { dose: '1000-2000 IU', frequency: '2-3x per week', duration: '8-12 weeks', notes: 'Higher dose for specific endpoints' }
    },
    amount: '5000 IU per vial', form: 'Lyophilized Powder', appearance: 'White / Off-White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₁₁₀₅H₁₇₇₀N₃₁₈O₃₃₆S₂₆', halfLife: '~24-36 hours',
    reconstitution: 'Add 5 mL BAC water for 1000 IU/mL.',
    syringe: 'Insulin syringe, 29-31 gauge', injectionSite: 'SubQ abdomen or IM deltoid/glute.',
    storage: 'Store at -4°F. Reconstituted: 36-46°F, use within 30 days.', administration: 'SubQ or IM',
  ...
  },
  {
    ...
    protocols: ['energy-vitality'],
    badge: '',
    tags: ['Hormonal', 'Testosterone', 'Fertility', 'LH', 'Value'],
    shortDesc: 'Higher-concentration HCG vial for extended hormonal research protocols.',
    description: 'Same compound as HCG 5000IU in a 10,000IU vial for cost-effective extended protocols.',
    benefits: ['Same benefits as HCG 5000IU', 'Double concentration', 'Cost-effective for longer protocols', 'Stimulates testosterone', 'Supports fertility research'],
    sideEffects: ['Water retention', 'Mood changes', 'Injection site pain', 'Headache', 'Gynecomastia risk'],
    dosing: {
      beginner: { dose: '250-500 IU', frequency: '2-3x per week', duration: '4-8 weeks', notes: 'Low dose maintenance' },
      intermediate: { dose: '500-1000 IU', frequency: '2-3x per week', duration: '8-12 weeks', notes: 'Standard protocol' },
      advanced: { dose: '1000-2000 IU', frequency: '2-3x per week', duration: '8-12 weeks', notes: 'Monitor estrogen levels' }
    },
    amount: '10,000 IU per vial', form: 'Lyophilized Powder', appearance: 'White / Off-White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₁₁₀₅H₁₇₇₀N₃₁₈O₃₃₆S₂₆', halfLife: '~24-36 hours',
    reconstitution: 'Add 5 mL BAC water for 2000 IU/mL.',
    syringe: 'Insulin syringe, 29-31 gauge', injectionSite: 'SubQ abdomen or IM.',
    storage: 'Store at -4°F. Reconstituted: 36-46°F, use within 30 days.', administration: 'SubQ or IM',
  ...
  },
  {
    ...
    protocols: ['fat-loss'],
    badge: '',
    tags: ['GLP-1', 'Metabolic', 'Appetite', 'Body Composition', 'Weekly'],
    shortDesc: 'GLP-1 receptor agonist studied for appetite regulation and body composition.',
    description: 'Semaglutide mimics the incretin hormone GLP-1 to influence insulin secretion, gastric emptying, and central appetite pathways. Extended half-life allows weekly dosing.',
    benefits: ['Potent GLP-1 receptor agonist', 'Appetite and satiety regulation', 'Body composition changes', 'Extended half-life (weekly dosing)', 'Well-characterized profile'],
    sideEffects: ['Nausea', 'Vomiting', 'Diarrhea', 'Constipation', 'Abdominal pain'],
    dosing: {
      beginner: { dose: '0.25 mg', frequency: '1x per week', duration: '4 weeks', notes: 'Start low for 4 weeks before increasing' },
      intermediate: { dose: '0.5-1.0 mg', frequency: '1x per week', duration: '8-12 weeks', notes: 'Increase by 0.25mg every 4 weeks' },
      advanced: { dose: '1.0-2.4 mg', frequency: '1x per week', duration: '12-24 weeks', notes: 'Titrate to max tolerated dose' }
    },
    amount: '10mg per vial', form: 'Lyophilized Powder', appearance: 'White / Off-White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₁₈₇H₂₉₁N₄₅O₅₉', halfLife: '~7 days',
    reconstitution: 'Add 2 mL BAC water for 5mg/mL.',
    syringe: 'Insulin syringe, 29-31 gauge', injectionSite: 'SubQ in abdomen, thigh, or upper arm.',
    storage: 'Store at -4°F. Reconstituted: 36-46°F, use within 28 days.', administration: 'SubQ',
  ...
  },
  {
    ...
    protocols: ['fat-loss'],
    badge: 'Best Seller',
    tags: ['GLP-1', 'GIP', 'Dual Agonist', 'Metabolic', 'Body Composition'],
    shortDesc: 'Dual GIP/GLP-1 receptor agonist with superior metabolic research potential.',
    description: 'Tirzepatide is a dual GIP and GLP-1 receptor agonist. Research suggests superior effects on body composition and glycemic control compared to single agonists.',
    benefits: ['Dual GIP + GLP-1 activity', 'Superior to single agonists in studies', 'Significant body composition effects', 'Extended weekly dosing', 'Novel mechanism of action'],
    sideEffects: ['Nausea', 'Diarrhea', 'Decreased appetite', 'Vomiting', 'Constipation'],
    dosing: {
      beginner: { dose: '2.5 mg', frequency: '1x per week', duration: '4 weeks', notes: 'Start at 2.5mg for at least 4 weeks' },
      intermediate: { dose: '5-7.5 mg', frequency: '1x per week', duration: '8-12 weeks', notes: 'Increase by 2.5mg every 4 weeks' },
      advanced: { dose: '10-15 mg', frequency: '1x per week', duration: '12-24 weeks', notes: 'Titrate to max tolerated dose' }
    },
    amount: '10mg per vial', form: 'Lyophilized Powder', appearance: 'White / Off-White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₂₂₅H₃₄₈N₄₈O₆₈', halfLife: '~5 days',
    reconstitution: 'Add 2 mL BAC water for 5mg/mL.',
    syringe: 'Insulin syringe, 29-31 gauge', injectionSite: 'SubQ in abdomen, thigh, or upper arm.',
    storage: 'Store at -4°F. Reconstituted: 36-46°F, use within 28 days.', administration: 'SubQ',
  ...
  },
  {
    ...
    shortDesc: 'Triple receptor agonist — the most advanced metabolic research peptide available.',
    description: 'Retatrutide is a tri-agonist targeting GLP-1, GIP, and glucagon receptors simultaneously. Research has shown the most significant body composition effects of any incretin-based compound.',
    benefits: ['Triple receptor agonist (GLP-1/GIP/Glucagon)', 'Most potent metabolic peptide studied', 'Significant body composition changes', 'Appetite regulation', 'Sustained weekly activity'],
    sideEffects: ['Nausea', 'Decreased appetite', 'Diarrhea', 'Injection site reactions', 'Constipation'],
    dosing: {
      beginner: { dose: '1 mg', frequency: '1x per week', duration: '4 weeks', notes: 'Start low and titrate gradually' },
      intermediate: { dose: '2-4 mg', frequency: '1x per week', duration: '8-12 weeks', notes: 'Increase by 1mg/week as tolerated' },
      advanced: { dose: '4-8 mg', frequency: '1x per week', duration: '12-24 weeks', notes: 'Do not exceed 12mg/week' }
    },
    amount: '10mg per vial', form: 'Lyophilized Powder', appearance: 'White / Off-White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₁₉₀H₂₈₂N₄₈O₆₀', halfLife: '~6 days',
    reconstitution: 'Add 2 mL BAC water for 5mg/mL.',
    syringe: 'Insulin syringe, 29-31 gauge', injectionSite: 'SubQ in abdomen, thigh, or upper arm.',
    storage: 'Store at -4°F. Reconstituted: 36-46°F, use within 28 days.', administration: 'SubQ',
  ...
  },
  {
    ...
    protocols: ['fat-loss'],
    badge: '',
    tags: ['GLP-1', 'GIP', 'Glucagon', 'Tri-Agonist', 'High Dose'],
    shortDesc: 'Double-concentration Retatrutide vial for advanced and extended metabolic protocols.',
    description: 'Same tri-agonist compound in a 20mg vial — cost-effective for advanced protocols requiring higher weekly doses.',
    benefits: ['Same tri-agonist benefits', 'Double concentration per vial', 'Cost-effective for advanced users', 'Fewer vials needed for long protocols', 'Sustained weekly activity'],
    sideEffects: ['Nausea', 'Decreased appetite', 'Diarrhea', 'Injection site reactions', 'Constipation'],
    dosing: {
      beginner: { dose: '1 mg', frequency: '1x per week', duration: '4 weeks', notes: 'Start low even with 20mg vial' },
      intermediate: { dose: '2-4 mg', frequency: '1x per week', duration: '8-12 weeks', notes: 'Titrate up gradually' },
      advanced: { dose: '4-12 mg', frequency: '1x per week', duration: '12-24 weeks', notes: '20mg vial provides ~2-5 weeks per vial at higher doses' }
    },
    amount: '20mg per vial', form: 'Lyophilized Powder', appearance: 'White / Off-White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₁₉₀H₂₈₂N₄₈O₆₀', halfLife: '~6 days',
    reconstitution: 'Add 4 mL BAC water for 5mg/mL.',
    syringe: 'Insulin syringe, 29-31 gauge', injectionSite: 'SubQ in abdomen, thigh, or upper arm.',
    storage: 'Store at -4°F. Reconstituted: 36-46°F, use within 28 days.', administration: 'SubQ',
  ...
  },
  {
    id: 'selank',
    name: 'Selank — 11mg',
    aka: 'Anxiolytic Peptide',
    category: 'freeze-dried',
    protocols: ['recovery-longevity'],
    badge: '',
    tags: ['Cognitive', 'Anxiolytic', 'Mood', 'Immune', 'Neuroprotective'],
    shortDesc: 'Synthetic peptide studied for anxiety reduction, mood, and immune modulation.',
    description: 'Selank is a synthetic analog of the immunomodulatory peptide tuftsin. Research shows anxiolytic, nootropic, and immunomodulatory effects without sedation or addiction potential.',
    benefits: ['Anxiolytic without sedation', 'Studied for mood enhancement', 'Immune modulation', 'Neuroprotective properties', 'No addiction potential'],
    sideEffects: ['Mild fatigue', 'Nasal irritation (intranasal)', 'Headache', 'Dizziness'],
    dosing: {
      beginner: { dose: '250-500 mcg', frequency: '1-2x daily', duration: '2-4 weeks', notes: 'Intranasal or SubQ' },
      intermediate: { dose: '500-750 mcg', frequency: '2x daily', duration: '4-8 weeks', notes: 'AM and afternoon dosing' },
      advanced: { dose: '750-1000 mcg', frequency: '2-3x daily', duration: '4-8 weeks', notes: 'Cycle 4-8 weeks on, 2-4 off' }
    },
    amount: '11mg per vial', form: 'Lyophilized Powder', appearance: 'White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₃₈H₅₇N₁₁O₁₀', halfLife: '~several minutes',
    reconstitution: 'Add 1.1 mL BAC water for 10mg/mL.',
    syringe: 'Insulin syringe or nasal spray device', injectionSite: 'Intranasal or SubQ.',
  ...
  },
  {
    id: 'semax',
    name: 'Semax — 10mg',
    aka: 'Nootropic Peptide',
    category: 'freeze-dried',
    protocols: ['recovery-longevity'],
    badge: '',
    tags: ['Cognitive', 'Nootropic', 'BDNF', 'Focus', 'Neuroprotective'],
    shortDesc: 'Nootropic peptide that increases BDNF for focus, memory, and neuroprotection.',
    description: 'Semax is a synthetic peptide analog of ACTH(4-10). It increases BDNF (brain-derived neurotrophic factor) and is studied for cognitive enhancement, neuroprotection, and focus.',
    benefits: ['Increases BDNF levels', 'Enhances focus and concentration', 'Studied for memory improvement', 'Neuroprotective properties', 'No stimulant-like side effects'],
    sideEffects: ['Nasal irritation', 'Mild headache', 'Hair loss (rare, high dose)', 'Dizziness'],
    dosing: {
      beginner: { dose: '200-400 mcg', frequency: '1-2x daily (AM)', duration: '2-4 weeks', notes: 'Intranasal preferred' },
      intermediate: { dose: '400-600 mcg', frequency: '2x daily', duration: '4-8 weeks', notes: 'AM and early afternoon' },
      advanced: { dose: '600-1000 mcg', frequency: '2-3x daily', duration: '4-8 weeks', notes: 'Cycle on/off' }
    },
    amount: '10mg per vial', form: 'Lyophilized Powder', appearance: 'White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₃₉H₅₃N₉O₁₀S', halfLife: '~several minutes',
    reconstitution: 'Add 1 mL BAC water for 10mg/mL.',
    syringe: 'Nasal spray device or insulin syringe', injectionSite: 'Intranasal preferred. SubQ also used.',
    storage: 'Store at -4°F. Reconstituted: 36-46°F, use within 14 days.', administration: 'Intranasal or SubQ',
  ...
  },
  {
    ...
    protocols: ['recovery-longevity'],
    badge: '',
    tags: ['Sleep', 'Recovery', 'Cortisol', 'Stress', 'Delta Wave'],
    shortDesc: 'Peptide studied for delta wave sleep induction, cortisol control, and recovery.',
    description: 'DSIP (Delta Sleep-Inducing Peptide) is studied for its ability to induce deep delta wave sleep. Research shows effects on cortisol regulation, stress response, and overnight recovery.',
    benefits: ['Induces delta wave deep sleep', 'Studied for cortisol normalization', 'Supports overnight recovery', 'May reduce stress response', 'Non-habit forming'],
    sideEffects: ['Morning grogginess', 'Headache', 'Vivid dreams', 'Mild nausea'],
    dosing: {
      beginner: { dose: '100-200 mcg', frequency: '1x daily before bed', duration: '2-4 weeks', notes: 'Take 30 min before sleep' },
      intermediate: { dose: '200-300 mcg', frequency: '1x daily before bed', duration: '4-8 weeks', notes: 'Consistent timing is important' },
      advanced: { dose: '300-500 mcg', frequency: '1x daily before bed', duration: '4-8 weeks', notes: 'Cycle 4-8 weeks on, 2-4 off' }
    },
    amount: '10mg per vial', form: 'Lyophilized Powder', appearance: 'White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₃₅H₄₈N₁₀O₁₅', halfLife: '~15-25 minutes',
    reconstitution: 'Add 2 mL BAC water for 5mg/mL.',
    syringe: 'Insulin syringe, 29-31 gauge', injectionSite: 'SubQ in abdominal fat or intranasal.',
  ...
  },
  {
    ...
    protocols: ['fat-loss'],
    badge: '',
    tags: ['Fat Loss', 'Lipolysis', 'HGH Fragment', 'Body Composition', 'Safe'],
    shortDesc: 'HGH fragment that stimulates lipolysis and inhibits fat formation without growth effects.',
    description: 'AOD-9604 is a modified fragment of HGH (amino acids 177-191). It retains fat-reducing properties without growth-promoting or diabetogenic effects. Stimulates lipolysis and inhibits lipogenesis.',
    benefits: ['Stimulates fat breakdown', 'Inhibits new fat formation', 'No blood sugar impact', 'May support cartilage repair', 'Strong safety profile'],
    sideEffects: ['Injection site redness', 'Headache', 'Mild nausea', 'Indigestion'],
    dosing: {
      beginner: { dose: '250 mcg', frequency: '1x daily fasted AM', duration: '8-12 weeks', notes: 'First thing in morning, empty stomach' },
      intermediate: { dose: '400 mcg', frequency: '1x daily fasted AM', duration: '12 weeks', notes: 'Wait 30 min before eating' },
      advanced: { dose: '500 mcg', frequency: '1x daily fasted AM', duration: '12-16 weeks', notes: 'Can split AM/PM fasted doses' }
    },
    amount: '10mg per vial', form: 'Lyophilized Powder', appearance: 'White / Off-White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₇₈H₁₂₅N₂₃O₂₃S₂', halfLife: '~30 minutes',
    reconstitution: 'Add 2 mL BAC water for 5mg/mL.',
    syringe: 'Insulin syringe, 29-31 gauge', injectionSite: 'SubQ in abdominal fat near target area.',
    storage: 'Store at -4°F. Reconstituted: 36-46°F, use within 28 days.', administration: 'SubQ',
  ...
  },
  {
    ...
    protocols: ['energy-vitality'],
    badge: '',
    tags: ['Growth Factor', 'Muscle Growth', 'Tissue Repair', 'Metabolic', 'IGF-1'],
    shortDesc: 'Extended half-life IGF-1 analog for growth, repair and metabolic signaling.',
    description: 'IGF-1 LR3 has an extended half-life vs. natural IGF-1. Studied for muscle hypertrophy, cell growth, and anti-catabolic effects.',
    benefits: ['Enhanced potency vs. natural IGF-1', 'Extended half-life', 'Muscle hypertrophy pathways', 'Promotes cell growth', 'Anti-catabolic effects'],
    sideEffects: ['Hypoglycemia', 'Joint pain', 'Water retention', 'Numbness/tingling'],
    dosing: {
      beginner: { dose: '20-40 mcg', frequency: '1x daily post-workout', duration: '4 weeks', notes: 'Monitor blood glucose. Take with food.' },
      intermediate: { dose: '40-60 mcg', frequency: '1x daily', duration: '4-6 weeks', notes: 'IM into trained muscle for local effect' },
      advanced: { dose: '60-100 mcg', frequency: '1x daily', duration: '4-6 weeks', notes: 'Cycle 4 on / 4 off' }
    },
    amount: '1mg per vial', form: 'Lyophilized Powder', appearance: 'White Powder',
    purity: '>99% (HPLC Verified)', molecularFormula: 'C₄₀₀H₆₂₅N₁₁₁O₁₁₅S₉', halfLife: '~20-30 hours',
    reconstitution: 'Add 1 mL BAC water for 1mg/mL.',
    syringe: 'Insulin syringe, 29-31 gauge', injectionSite: 'IM into trained muscle or SubQ.',
    storage: 'Store at -4°F. Reconstituted: 36-46°F, use within 14 days.', administration: 'IM or SubQ',
    warnings: 'Monitor blood glucose — hypoglycemia risk. Short cycles only. Not for active cancer.',
    suggestedCompanions: ['ipamorelin', 'hgh-10', 'mk677'],
